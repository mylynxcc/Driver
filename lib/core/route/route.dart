...
class RouteHelper {
  ...
  static const String vehicleVerificationScreen =
      '/vehicle_verification_screen';

  static const String driverProfileVerificationScreen =
      '/driver_verification_screen';
  ...
  List<GetPage> routes = [
    ...
    GetPage(
        name: allRideScreen,
        page: () => const AllRideScreen(),
        transition: Transition.fadeIn,
        transitionDuration: const Duration(milliseconds: 300)),
    GetPage(
        name: cityRideScreen,
        page: () => CityRideScreen(isShowBackButton: Get.arguments[0]),
        transition: Transition.fadeIn,
        transitionDuration: const Duration(milliseconds: 300)),
    GetPage(
        name: interCityRideScreen,
        page: () => InterCityRideScreen(isShowBackButton: Get.arguments[0]),
        transition: Transition.fadeIn,
        transitionDuration: const Duration(milliseconds: 300)),
    ...
    GetPage(
        name: addWithdrawMethodScreen, page: () => const AddWithdrawMethod()),
    GetPage(
    ...
    GetPage(
        name: transactionHistoryScreen, page: () => const TransactionsScreen()),
    GetPage(

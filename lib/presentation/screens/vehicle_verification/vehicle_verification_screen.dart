                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              CustomTextField(
                                ...
                                onTap: () {
                                  printX(
                                      "controller.modelList.length ${controller.modelList.length}");
                              ...
                              RoundedButton(
                                ...
                                press: () {
                                  printX(
                                      "model>>> ${controller.modelValue.name}");
                                  printX(
                                      "color>>> ${controller.colorValue.name}");
                                  printX(
                                      "year>>> ${controller.yearValue.name}");

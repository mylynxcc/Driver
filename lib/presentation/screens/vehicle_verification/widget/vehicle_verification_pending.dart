                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        MyImageWidget(
                            imageUrl:
                                "${controller.brandImagePath}/${controller.pendingVehicleData?.brand?.image ?? ''}",
                            height: 60,
                            width: 60,
                            radius: 10),
                        SizedBox(height: 10),
                        Row(
                          children: [
                            Text("${MyStrings.brandName.tr} : ",
                                style: mediumDefault),
                            Text(
                                controller.pendingVehicleData?.brand?.name ??
                                    '',
                                style: mediumDefault.copyWith()),
                          ],
                        ),
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [
                        Text("Vehicle Image".tr, style: boldLarge),
                        SizedBox(height: 10),
                        MyImageWidget(
                            imageUrl:
                                controller.pendingVehicleData?.imageSrc ?? '',
                            height: 100,
                            width: 100,
                            radius: 10),
                        SizedBox(height: 10),

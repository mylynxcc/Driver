...
class RideDetailsBottomSheetSection extends StatefulWidget {
  ...
  @override
  State<RideDetailsBottomSheetSection> createState() =>
      _RideDetailsBottomSheetSectionState();
}

class _RideDetailsBottomSheetSectionState
    extends State<RideDetailsBottomSheetSection> {
                ...
                RoundedButton(
                  ...
                  press: () {
                    ...
                    DownloadService.downloadPDF(
                      ...
                      fileName:
                          "${Environment.appName}_recipt_${controller.ride.id}.pdf",
                    );
                    setState(() {

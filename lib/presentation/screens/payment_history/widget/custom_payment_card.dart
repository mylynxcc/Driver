          ...
          children: [
            Row(
              ...
              children: [
                Expanded(
                    child: CardColumn(
                        header: MyStrings.rideUid.tr, body: riderName)),
                Expanded(
                  child: CardColumn(
                    alignmentEnd: true,
            ...
            Row(
              ...
              children: [
                Expanded(
                  ...
                  body:
                      '${StringConverter.formatNumber(amountData)} ${Get.find<ApiClient>().getCurrencyOrUsername()}',
                  textColor: MyColor.primaryTextColor,
                )),
                Expanded(
                    child: CardColumn(
                        alignmentEnd: true,
                        header: MyStrings.paymentType.tr,
                        body: paymentType == "1"

...
class _TransactionsScreenState extends State<TransactionsScreen> {
  ...
  void initState() {
    ...
    final controller =
        Get.put(TransactionsController(transactionRepo: Get.find()));
              ...
              controller.isLoading
                  ...
                  : Expanded(
                      child: controller.transactionList.isEmpty &&
                          ...
                          ? const Center(
                              child: NoDataWidget(
                                  text: MyStrings.noTrxFound, margin: 6))
                                            ...
                                            dateData: DateConverter
                                                .isoToLocalDateAndTime(
                                                    controller
                                                        ...
                                                        ""),
                                            amountData:
                                                "${controller.transactionList[index].trxType} ${StringConverter.formatNumber(controller.transactionList[index].amount.toString())} ${controller.transactionList[index].currency ?? ''}",
                                            postBalanceData:
                                                "${StringConverter.formatNumber(controller.transactionList[index].postBalance.toString())} ${controller.transactionList[index].currency ?? ''}"),
                                      );
                                    },
                                  ),
                                ))

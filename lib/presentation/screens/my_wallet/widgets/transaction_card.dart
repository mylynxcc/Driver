        ...
        child: Row(
          ...
          children: [
                ...
                children: [
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: transaction.trxType == "-"
                              ? MyColor.colorRed.withValues(alpha: 0.2)
                              : MyColor.colorGreen.withValues(alpha: 0.2),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          (transaction.remark?.replaceAll('_', ' ') ?? '')
                              .toTitleCase(),
            ...
            Expanded(
              ...
              child: CardColumn(
                header:
                    "$currency${StringConverter.formatNumber("${transaction.amount}".toString())}",

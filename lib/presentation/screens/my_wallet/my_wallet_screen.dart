  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(MyStrings.myWallet.tr,
            style: boldLarge.copyWith(color: MyColor.getAppBarContentColor())),
        leading: IconButton(
            onPressed: () {
              Get.back();
            },
                            ...
                            children: [
                              ...
                              HeaderText(
                                  text: controller.isLoading
                                      ? '${controller.currencySym}0.0'
                                      : '${controller.currencySym}${StringConverter.formatNumber(controller.driver.balance ?? '0')}',

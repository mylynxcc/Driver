...
import 'package:ovoride_driver/presentation/screens/ride_history/widget/complete_ride_card.dart';
        ...
        return RefreshIndicator(
          ...
          child: controller.isLoading
              ...
              : controller.isLoading == false && controller.allRideList.isEmpty
                  ? NoDataWidget(
                      isRide: true,
                      text: MyStrings.sorryThereIsNoCompleteRideFound.tr)
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return controller.allRideList[index].status ==
                            ...
                            ? AcceptedRideCard(
                                ...
                                imageUrl:
                                    '${UrlContainer.domainUrl}/${controller.imagePath}/${controller.allRideList[index].user?.avatar}',
                                cancelCallback: () {
                                  CustomBottomSheet(
                                    child: CancelBottomSheet(
                                      ride: controller.allRideList[index],
                                      press: () {
                                        Get.find<AcceptedRideController>()
                                            .cancelRide(controller
                                                .allRideList[index].id
                                                .toString())
                                            .then((value) {
                                          controller.getAllRideList(p: 1);
                                        });
                            ...
                            : AllRideCard(
                                ...
                                ride: controller.allRideList[index],
                                isPaymentDone: true,
                                isReviewDone: controller
                                            .allRideList[index].driverReview !=
                                        null
                                    ? true
                                    : false,
                                imageUrl:

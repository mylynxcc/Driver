      ...
      builder: (controller) {
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text(MyStrings.profile.tr,
                style:
                    boldLarge.copyWith(color: MyColor.getAppBarContentColor())),
            leading: IconButton(
                onPressed: () {
                  Get.back();
                },

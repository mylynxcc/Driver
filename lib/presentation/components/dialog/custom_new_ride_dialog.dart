...
class CustomNewRideDialog {
              ...
              IntrinsicWidth(
                child: TextFormField(
                  ...
                  style: mediumDefault.copyWith(
                    fontSize: 30,
                    color: dashboardController.amountController.text.isNotEmpty
                        ? MyColor.primaryColor
                        : Colors.grey.shade500,
                  ),
  ...
  static destination(
      {required String pickupLocation, required String destination}) {
    return CustomTimeLine(
      ...
      firstWidget: Padding(
        ...
        child: Column(
          children: [
            Text(pickupLocation.toTitleCase(),
      ...
      secondWidget: Padding(
        ...
        child: Text(destination.toTitleCase(),

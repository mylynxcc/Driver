...
class PaymentHistoryModel {
  ...
  factory PaymentHistoryModel.fromJson(Map<String, dynamic> json) =>
      PaymentHistoryModel(
        ...
        paymentType:
            json["payment_type"] != null ? json["payment_type"].toString() : "",
...
class Rider {
  ...
  factory Rider.fromJson(Map<String, dynamic> json) => Rider(
        ...
        kycRejectionReason: json["kyc_rejection_reason"] != null
...
class Ride {
  ...
  factory Ride.fromJson(Map<String, dynamic> json) => Ride(
        ...
        driverId: json["driver_id"] != null ? json["driver_id"].toString() : "",
        serviceId:
            json["service_id"] != null ? json["service_id"].toString() : "",
        gatewayCurrencyId: json["gateway_currency_id"] != null
            ? json["gateway_currency_id"].toString()
            : "",
        pickupLocation: json["pickup_location"] != null
            ? json["pickup_location"].toString()
            : "",
        pickupLatitude: json["pickup_latitude"] != null
            ? json["pickup_latitude"].toString()
            : "",
        pickupLongitude: json["pickup_longitude"] != null
            ? json["pickup_longitude"].toString()
            : "",
        destination:
            json["destination"] != null ? json["destination"].toString() : "",
        duration: json["duration"] != null ? json["duration"].toString() : "",
        distance: json["distance"] != null ? json["distance"].toString() : "",
        pickupZoneId: json["pickup_zone_id"] != null
            ? json["pickup_zone_id"].toString()
            : "",
        destinationZoneId: json["destination_zone_id"] != null
            ? json["destination_zone_id"].toString()
            : "",
        ...
        destinationLongitude: json["destination_longitude"] != null
            ...
            : "",
        recommendAmount: json["recommend_amount"] != null
            ? json["recommend_amount"].toString()
            : "",
        minAmount:
            json["min_amount"] != null ? json["min_amount"].toString() : "",
        maxAmount:
            json["max_amount"] != null ? json["max_amount"].toString() : "",
        note: json["note"] != null ? json["note"].toString() : "",
        numberOfPassenger: json["number_of_passenger"] != null
            ? json["number_of_passenger"].toString()
            : "",
        otp: json["otp"] != null ? json["otp"].toString() : "",
        startTime:
            json["start_time"] != null ? json["start_time"].toString() : "",
        endTime: json["end_time"] != null ? json["end_time"].toString() : "",
        cancelReason: json["cancel_reason"] != null
            ? json["cancel_reason"].toString()
            : "",
        cancelledAt:
            json["cancelled_at"] != null ? json["cancelled_at"].toString() : "",
        amount: json["amount"] != null ? json["amount"].toString() : "",
        ...
        commissionAmount: json["commission_amount"] != null
            ...
            : "",
        appliedCouponId: json["applied_coupon_id"] != null
            ? json["applied_coupon_id"].toString()
            : "",
        status: json["status"] != null ? json["status"].toString() : "",
        paymentType:
            json["payment_type"] != null ? json["payment_type"].toString() : "",
        paymentStatus: json["payment_status"] != null
            ...
            : "",
        canceledUserType: json["canceled_user_type"] != null
            ? json["canceled_user_type"].toString()
            : "",

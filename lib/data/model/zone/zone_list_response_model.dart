...
ZoneListResponseModel zoneListResponseModelFromJson(String str) =>
    ZoneListResponseModel.fromJson(json.decode(str));
...
class ZoneListResponseModel {
  ...
  factory ZoneListResponseModel.fromJson(Map<String, dynamic> json) =>
      ZoneListResponseModel(
        remark: json["remark"],
        status: json["status"],

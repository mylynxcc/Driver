...
DriverKycResponseModel kycResponseModelFromJson(String str) =>
    DriverKycResponseModel.fromJson(json.decode(str));
...
class DriverKycResponseModel {
  ...
  factory DriverKycResponseModel.fromJson(Map<String, dynamic> json) =>
      DriverKycResponseModel(
        remark: json["remark"],
        status: json["status"],

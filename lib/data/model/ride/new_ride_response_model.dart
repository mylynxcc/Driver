...
NewRideListResponseModel cancelRideListResponseModelFromJson(String str) =>
    NewRideListResponseModel.fromJson(json.decode(str));
...
class NewRideListResponseModel {
  ...
  factory NewRideListResponseModel.fromJson(Map<String, dynamic> json) =>
      NewRideListResponseModel(
        remark: json["remark"],
        status: json["status"],

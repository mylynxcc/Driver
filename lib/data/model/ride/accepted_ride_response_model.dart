...
AcceptedRideResponseModel cancelRideListResponseModelFromJson(String str) =>
    AcceptedRideResponseModel.fromJson(json.decode(str));
...
class AcceptedRideResponseModel {
  ...
  factory AcceptedRideResponseModel.fromJson(Map<String, dynamic> json) =>
      AcceptedRideResponseModel(
        remark: json["remark"],
        status: json["status"],

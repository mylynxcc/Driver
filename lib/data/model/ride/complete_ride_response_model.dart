...
AllRideResponseModel completeRideResponseModelFromJson(String str) =>
    AllRideResponseModel.fromJson(json.decode(str));
...
class AllRideResponseModel {
  ...
  factory AllRideResponseModel.fromJson(Map<String, dynamic> json) =>
      AllRideResponseModel(
        remark: json["remark"],
        status: json["status"],
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        allRides:
            json["rides"] == null ? null : AllRides.fromJson(json["rides"]),

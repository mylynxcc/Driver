...
DashBoardRideResponseModel newRideResponseModelFromJson(String str) =>
    DashBoardRideResponseModel.fromJson(json.decode(str));
...
class DashBoardRideResponseModel {
  ...
  factory DashBoardRideResponseModel.fromJson(Map<String, dynamic> json) =>
      DashBoardRideResponseModel(
        remark: json["remark"],
        status: json["status"],
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
      ride: json["rides"] == null
          ? null
          : RideMainDataList.fromJson(json["rides"]),
      driverInfo: json["driver"] == null
          ? null
          : GlobalDriverInfo.fromJson(json["driver"]),
      runningRide: json["running_rides"] == null
          ? null
          : RideModel.fromJson(json["running_rides"]),
      driverImagePath: json["driver_image_path"].toString(),
      userImagePath: json["user_image_path"].toString(),
      pendingRides: json["pendingRides"] == null
          ? []
          : List<RideModel>.from(
              json["pendingRides"]!.map((x) => RideModel.fromJson(x))));
...
class RideMainDataList {
  ...
  factory RideMainDataList.fromJson(Map<String, dynamic> json) =>
      RideMainDataList(
        data: json["data"] == null
            ? []
            : List<RideModel>.from(
